...
query_insertar_employees = " INSERT INTO abc_corporation.employees (employee_number,age,gender,year_birth,marital_status,attrition) VALUES (%,%,%,%,%,%)"

query_insertar_employees_details = " INSERT INTO abc_corporation.employees_details (employee_number,department,job_role,remote_work,distance_from_home,overtime,business_travel,stock_option_level) VALUES (%,%,%,%,%,%,%,%)"

query_insertar_education = " INSERT INTO abc_corporation.education (employee_number,education,education_field) VALUES (%,%)"

query_insertar_salaries = " INSERT INTO abc_corporation.salaries (employee_number,monthly_income,monthly_rate,hourly_rate,percent_salary_hike) VALUES (%,%,%,%,%,%)"

query_insertar_satisfaction = " INSERT INTO abc_corporation.satisfaction (employee_number,environment_satisfaction,job_involvement,job_satisfaction,relationship_satisfaction,work_life_balance) VALUES (%,%,%,%,%,%)"
...
query_baja_employees = " DELETE FROM abc_corporation.employees WHERE employee_number = %s"

query_modificar_employees = " UPDATE abc_corporation.employees SET age = %s, gender = %s, year_birth = %s, marital_status = %s, attrition =%s WHERE employee_number = %s"